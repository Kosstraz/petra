...
#ifndef EGIDE_STRING_HPP
#define EGIDE_STRING_HPP
...
public:
	...
	inline int	CompareWith(const char* data)	const;
	inline int	CompareWith(const String& str)	const;
	inline int	CompareNByteWith(const char* data, unsigned int n)	const;
	inline int	CompareNByteWith(const String& str, unsigned int n)	const;

	inline bool	IsEqualWith(const char* data)	const;
	inline bool	IsEqualWith(const String& str)	const;
	inline bool	IsNByteEqualWith(const char* data, unsigned int n)	const;
	inline bool	IsNByteEqualWith(const String& str, unsigned int n)	const;
...
public:
	...
	FORCEINLINE bool	operator<(const String& str)	const noexcept;
	FORCEINLINE bool	operator>(const String& str)	const noexcept;
	FORCEINLINE bool	operator<=(const String& str)	const noexcept;
	FORCEINLINE bool	operator>=(const String& str)	const noexcept;
	FORCEINLINE bool	operator==(const String& str)	const noexcept;
	FORCEINLINE int		operator<=>(const String& str)	const noexcept;
	FORCEINLINE bool	operator!=(const String& str)	const noexcept;
